<template>
	<div class="wrapper">
		<el-form ref="loginForm" class="login-box" :model="form" status-icon :rules="rules" label-width="80px"
			style="background-color: #fff;border-radius: 10px;position: relative;top:100px">
